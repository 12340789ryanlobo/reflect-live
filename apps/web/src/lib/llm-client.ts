...
export function getLlmConfig(): LlmConfig {
  ...
  return {
    ...
    provider,
    apiKey,
    // Default to OpenAI's open-source 120B on OpenRouter's free tier —
    // currently less saturated than Llama/Gemma, and excellent at
    // following structured-JSON instructions. Override via LLM_MODEL env
    // var (e.g. paid `openai/gpt-4o-mini` once credit is loaded).
